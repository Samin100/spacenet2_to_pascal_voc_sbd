...
for raster_file in listdir(my_raster_dir):
	...
	print("Raster name : ",my_raster_dir+'/'+my_raster_source)
	...
	my_vector_source = 'buildings/buildings_AOI_2_Vegas_img'+str(image_number)+'.geojson'
	print("Vector name : ",my_vector_dir+'/'+my_vector_source)
	...
	#Save the files
	scipy.io.savemat(my_cls_dir+'/'+'RGB-PanSharpen_AOI_2_Vegas_img'+str(image_number)+'.mat',{'GTcls': GTcls})
	scipy.io.savemat(my_inst_dir+'/'+'RGB-PanSharpen_AOI_2_Vegas_img'+str(image_number)+'.mat',{'GTinst': GTinst})
